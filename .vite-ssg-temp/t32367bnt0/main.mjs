...
const inactiveY = "/assets/inactiveY-CcCdEnsy.png";
...
const InactiveChart = () => {
  return /* @__PURE__ */ jsxs("div", { className: "inactive-chart", children: [
    ...
    /* @__PURE__ */ jsx("img", { src: inactiveKey, height: "80vh", style: { marginTop: "20px" } })
  ] });
};
...
const top20 = "/assets/Top20-hvN3sjHL.png";
const trucks = "/assets/Trucks-CrT8Lew-.png";
...
const GridPage = () => {
  ...
  return /* @__PURE__ */ jsxs(GridContainer, { children: [
    ...
    /* @__PURE__ */ jsxs(BodyText, { children: [
      ...
      /* @__PURE__ */ jsx("br", {}),
      /* @__PURE__ */ jsx("img", { src: trucks, alt: "An assortment of UCLA's food truck offerings." }),
    ...
    /* @__PURE__ */ jsxs(BodyText, { children: [
      ...
      /* @__PURE__ */ jsx(FullWidthImageWrapper, { children: /* @__PURE__ */ jsx(FullWidthImage, { src: top20, alt: "Top 20 food trucks, based off all-time swipes (Fall 2022 - Fall 2024)" }) })
    ] }),
    ...
    /* @__PURE__ */ jsxs(BodyText, { children: [
      ...
      /* @__PURE__ */ jsx("img", { src: dinnerDecrease, alt: "Daily Number of Food Trucks During Dinner Meal Period", style: { width: "90%", margin: "20px auto", display: "block" } }),
